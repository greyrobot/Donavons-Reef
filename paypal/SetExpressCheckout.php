...
function PPHttpPost($methodName_, $nvpStr_) {
	...
	$API_UserName = urlencode('master_1231185381_biz_api1.gmail.com');
	$API_Password = urlencode('1231185391');
	$API_Signature = urlencode('AsD02Z4qt4zDhHwsb5XVV2iAzf9eAhdgOqqJSPNcBhpx0XIV-ZJFFhr2 ');
