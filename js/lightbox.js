...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			Settings.baseUrl+'/images/page_loader.gif',		// (string) Path and the name of the loading icon
			...
			imageBtnClose:			Settings.baseUrl+'/images/close-btn.png',		// (string) Path and the name of the close btn
